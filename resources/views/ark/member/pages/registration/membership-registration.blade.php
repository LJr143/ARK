                        ...
                        <div class="card-body">
                            ...
                            @if($currentStep == 1)
                                <form method="POST" action="{{ route('membership.save-step', ['step' => 1]) }}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label for="family_name" class="form-label required-field">Family
                                                Name</label>
                                            <input type="text"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select @error('sex') is-invalid @enderror" id="sex"
                                                    name="sex">
                                                <option value="">Select...</option>
                                                <option
                                                    value="Male" {{ (old('sex', $memberData['sex'] ?? '') == 'Male' ? 'selected' : '') }}>
                                                    Male
                                                </option>
                                                <option
                                                    value="Female" {{ (old('sex', $memberData['sex'] ?? '') == 'Female' ? 'selected' : '') }}>
                                                    Female
                                                </option>
                                                <option
                                                    value="Other" {{ (old('sex', $memberData['sex'] ?? '') == 'Other' ? 'selected' : '') }}>
                                                    Other
                                                </option>
                                            </select>
                                            @error('sex')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label for="civil_status" class="form-label required-field">Civil
                                                Status</label>
                                            <select class="form-select @error('civil_status') is-invalid @enderror"
                                                    id="civil_status" name="civil_status">
                                                <option value="">Select...</option>
                                                <option
                                                    value="Single" {{ (old('civil_status', $memberData['civil_status'] ?? '') == 'Single' ? 'selected' : '') }}>
                                                    Single
                                                </option>
                                                <option
                                                    value="Married" {{ (old('civil_status', $memberData['civil_status'] ?? '') == 'Married' ? 'selected' : '') }}>
                                                    Married
                                                </option>
                                                <option
                                                    value="Divorced" {{ (old('civil_status', $memberData['civil_status'] ?? '') == 'Divorced' ? 'selected' : '') }}>
                                                    Divorced
                                                </option>
                                                <option
                                                    value="Widowed" {{ (old('civil_status', $memberData['civil_status'] ?? '') == 'Widowed' ? 'selected' : '') }}>
                                                    Widowed
                                                </option>
                                            </select>
                                            @error('civil_status')
                                        ...
                                        <div class="col-md-8">
                                            <label for="permanent_address" class="form-label required-field">Permanent
                                                Address</label>
                                            <textarea
                                                class="form-control @error('permanent_address') is-invalid @enderror"
                                                id="permanent_address" name="permanent_address"
                                                rows="2">{{ old('permanent_address', $memberData['permanent_address'] ?? '') }}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="facebook_id" name="facebook_id"
                            ...
                            @if($currentStep == 2)
                                <form method="POST" action="{{ route('membership.save-step', ['step' => 2]) }}">
                                    @csrf
                                    <h5 class="mb-4 text-primary"><i class="bi bi-briefcase"></i> Professional
                                        Information</h5>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="company_address" name="company_address"
                                                      rows="2">{{ old('company_address', $memberData['company_address'] ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="company_telephone" name="company_telephone"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="company_fax" name="company_fax"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="school_graduated" class="form-label required-field">School
                                                Graduated</label>
                                            <input type="text"
                                                   class="form-control @error('school_graduated') is-invalid @enderror"
                                                   id="school_graduated" name="school_graduated"
                                        ...
                                        <div class="col-md-3">
                                            <label for="year_graduated" class="form-label required-field">Year
                                                Graduated</label>
                                            <input type="number"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="post_graduate_school" class="form-label">Post Graduate
                                                School</label>
                                            <input type="text" class="form-control" id="post_graduate_school"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" class="form-control" id="post_graduate_year"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="post_graduate_honors"
                                                   name="post_graduate_honors"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="special_courses" class="form-label">Special Courses
                                                Taken</label>
                                            <textarea class="form-control" id="special_courses" name="special_courses"
                                                      rows="2">{{ old('special_courses', $memberData['special_courses'] ?? '') }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="awards" class="form-label">Awards Received</label>
                                            <textarea class="form-control" id="awards" name="awards"
                                                      rows="2">{{ old('awards', $memberData['awards'] ?? '') }}</textarea>
                                        </div>
                                    </div>

                                    <div class="d-flex justify-content-between mt-4">
                                        <a href="{{ route('membership.form', ['step' => 1]) }}"
                            ...
                            @if($currentStep == 3)
                                <form method="POST" action="{{ route('membership.save-step', ['step' => 3]) }}">
                                    @csrf
                                    <h5 class="mb-4 text-primary"><i class="bi bi-file-earmark-medical"></i> PRC Details
                                    </h5>

                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="prc_registration_number" class="form-label required-field">PRC
                                                Registration Number</label>
                                            <input type="text"
                                                   class="form-control @error('company_name') is-invalid @enderror"
                                                   id="prc_registration_number" name="prc_registration_number"
                                        ...
                                        <div class="col-md-3">
                                            <label for="prc_date_issued" class="form-label required-field">Date
                                                Issued</label>
                                            <input type="date"
                                                   class="form-control @error('prc_date_issued') is-invalid @enderror"
                                                   id="prc_date_issued" name="prc_date_issued"
                                        ...
                                        <div class="col-md-3">
                                            <label for="prc_valid_until" class="form-label required-field">Valid
                                                Until</label>
                                            <input type="date"
                                                   class="form-control @error('prc_valid_until') is-invalid @enderror"
                                                   id="prc_valid_until" name="prc_valid_until"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <label for="expertise"
                                                   class="form-label required-field">Expertise/Specialization</label>
                                            <textarea class="form-control @error('expertise') is-invalid @enderror"
                                                      id="expertise" name="expertise"
                                                      rows="2">{{ old('expertise', $memberData['expertise'] ?? '') }}</textarea>
                                            @error('expertise')
                                            <div class="invalid-feedback d-flex align-items-center">
                                                <svg class="bi flex-shrink-0 me-2" width="16" height="16"
                                                     fill="currentColor"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label for="years_of_practice" class="form-label required-field">Years of
                                                Practice</label>
                                            <input type="number"
                                                   class="form-control @error('years_of_practice') is-invalid @enderror"
                                        ...
                                        <div class="col-md-4">
                                            <label for="practice_type" class="form-label required-field">Type of
                                                Practice</label>
                                            <select class="form-select @error('practice_type') is-invalid @enderror"
                                                    id="practice_type" name="practice_type">
                                                <option value="">Select...</option>
                                                <option
                                                    value="Private" {{ (old('practice_type', $memberData['practice_type'] ?? '') == 'Private') ? 'selected' : '' }}>
                                                    Private
                                                </option>
                                                <option
                                                    value="Government" {{ (old('practice_type', $memberData['practice_type'] ?? '') == 'Government') ? 'selected' : '' }}>
                                                    Government
                                                </option>
                                                <option
                                                    value="Academe" {{ (old('practice_type', $memberData['practice_type'] ?? '') == 'Academe') ? 'selected' : '' }}>
                                                    Academe
                                                </option>
                                                <option
                                                    value="Mixed" {{ (old('practice_type', $memberData['practice_type'] ?? '') == 'Mixed') ? 'selected' : '' }}>
                                                    Mixed
                                                </option>
                                            </select>
                                            @error('practice_type')
                                        ...
                                        <div class="col-md-4">
                                            <label for="services_rendered" class="form-label required-field">Services
                                                Rendered</label>
                                            <textarea
                                                class="form-control  @error('services_rendered') is-invalid @enderror"
                                                id="services_rendered" name="services_rendered"
                                                rows="1">{{ old('services_rendered', $memberData['services_rendered'] ?? '') }}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <label for="cpe_seminars_attended" class="form-label">Seminars/Conferences
                                                Attended
                                                (Last 3 Years)</label>
                                            <textarea class="form-control" id="cpe_seminars_attended"
                                                      name="cpe_seminars_attended"
                                                      rows="3">{{ old('cpe_seminars_attended', $memberData['cpe_seminars_attended'] ?? '') }}</textarea>
                                            <small class="text-muted">Please list the title, date, and venue for each
                                                seminar</small>
                                        </div>
                                    </div>

                                    <div class="d-flex justify-content-between mt-4">
                                        <a href="{{ route('membership.form', ['step' => 2]) }}"
                                           class="btn btn-secondary">
                                            <i class="bi bi-arrow-left"></i> Back
                                        </a>
                                        <button type="submit" class="btn btn-primary">
                            ...
                            @if($currentStep == 4)
                                <form method="POST" action="{{ route('membership.save-step', ['step' => 4]) }}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="current_chapter" class="form-label required-field">Current
                                                Chapter</label>
                                            <input type="text"
                                                   class="form-control  @error('current_chapter') is-invalid @enderror"
                                                   id="current_chapter" name="current_chapter"
                                        ...
                                        <div class="col-md-6">
                                            <label for="previous_chapter" class="form-label">Previous Chapter (if
                                                any)</label>
                                            <input type="text" class="form-control" id="previous_chapter"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="positions_held" name="positions_held"
                                                      rows="3">{{ old('positions_held', $memberData['positions_held'] ?? '') }}</textarea>
                                            <small class="text-muted">Please include the year and chapter for each
                                                position</small>
                                        </div>
                                    </div>

                                    <div class="d-flex justify-content-between mt-4">
                                        <a href="{{ route('membership.form', ['step' => 3]) }}"
                                           class="btn btn-secondary">
                                            <i class="bi bi-arrow-left"></i> Back
                                        </a>
