            ...
            <div class="px-8 py-6">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6">
                        ...
                        @error('username')
                        <div class="flex items-center mt-2 text-[11px] text-red-600">
                    ...
                    <div class="relative">
                        ...
                        <div>
                            <x-button
                                class="flex items-center justify-center w-full hover:text-white py-3 text-black text-center bg-white hover:from-blue-600 hover:to-blue-700 font-medium rounded-lg transition shadow-md hover:shadow-lg">
