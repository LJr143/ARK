    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 ">Members Management</h1>
                    <p class="text-sm text-gray-600 mt-1">Manage your organization members efficiently</p>
                </div>
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                    <button wire:click="downloadTemplate"
                            wire:loading.attr="disabled"
                            wire:loading.class="opacity-75 cursor-not-allowed"
                            class="flex-1 sm:flex-none bg-indigo-600 hover:bg-indigo-700 text-white px-3 sm:px-4 py-2 rounded font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md">
                        <!-- Default state -->
            ...
            <svg class="animate-spin w-4 sm:w-5 h-4 sm:h-5" fill="none" viewBox="0 0 24 24">
                ...
                <path class="opacity-75" fill="currentColor"
                    ...
                    <button wire:click="openImportModal"
                            class="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md">
                        <svg class="w-4 sm:w-5 h-4 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <svg class="animate-spin w-4 sm:w-5 h-4 sm:h-5" fill="none" viewBox="0 0 24 24">
                ...
                <path class="opacity-75" fill="currentColor"
                    ...
                    <button wire:navigate href="{{ route('membership.form') }}"
                        ...
                        <span class="text-sm">Membership Registration</span>
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $this->date_added }}</p>
                            </div>
                            <div>
        ...
        @if($showImportModal)
            <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4"
                 ...
                 x-transition:leave-start="opacity-100 scale-100"
                 x-transition:leave-end="opacity-0 scale-95">
                <div class="relative bg-white rounded-2xl shadow-xl border border-gray-200 w-full max-w-md sm:max-w-lg">
                    <form wire:submit.prevent="import">
                        <div class="flex justify-between items-center border-b border-gray-200 p-4 sm:p-6">
                            <h3 class="text-lg sm:text-xl font-semibold text-gray-900">Import Members</h3>
                        ...
                        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                            ...
                            <!-- File Upload -->
                            <div class="space-y-2">
                                <label class="block text-sm font-medium text-gray-700">Choose File <span class="text-red-500">*</span></label>
                                <div class="mt-1 flex justify-center px-4 sm:px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded">
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                                ...
                                                <input wire:model="importFile" id="file-upload" name="file-upload" type="file" class="sr-only" accept=".xlsx,.xls,.csv">
                                            </label>
                                ...
                                @error('importFile') <span class="text-red-500 text-xs sm:text-sm">{{ $message }}</span> @enderror
                                @if($importFile)
                            ...
                            @if($importResults)
                                <div class="bg-gray-50 border border-gray-200 rounded p-4 space-y-3">
                                    ...
                                    <div class="text-sm text-gray-700 space-y-2">
                                        <p><span class="font-medium">Successful Imports:</span> {{ $importResults['successful'] }}</p>
                                        <p><span class="font-medium">Duplicates Skipped:</span> {{ $importResults['duplicates'] }}</p>
                        ...
                        <div class="flex justify-end gap-3 p-4 sm:p-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                    wire:loading.attr="disabled"
                                    wire:loading.class="opacity-75 cursor-not-allowed"
                                    class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-medium transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2">
                                <!-- Default state -->
