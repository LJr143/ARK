                    ...
                    @if($totalMembers > 0)
                        <div class="mt-4 bg-emerald-50 rounded-lg p-3">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-semibold text-emerald-800">{{ round(($paidMembers / $totalMembers) * 100) }}%</span>
                            </div>
                    ...
                    @if($totalMembers > 0)
                        <div class="mt-4 bg-red-50 rounded-lg p-3">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-semibold text-red-800">{{ round(($unpaidMembers / $totalMembers) * 100) }}%</span>
                            </div>
                    ...
                    @if($totalDues > 0)
                        <div class="mt-4 bg-indigo-50 rounded-lg p-3">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span
                                    class="font-semibold text-indigo-800">{{ round(($paidDues / $totalDues) * 100) }}%</span>
                            </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Payment trends from {{ \Carbon\Carbon::parse($startDate)->format('M d, Y') }}
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-red-600">₱{{ number_format($unpaidDues, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Active Members</span>
                            <span class="font-semibold text-indigo-600">{{ $totalMembers }}</span>
                        </div>
                    </div>
                </div>
            </div>
