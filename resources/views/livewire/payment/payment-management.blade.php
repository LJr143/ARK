    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 ">Membership Payments Management</h1>
                    <p class="text-sm text-gray-600 mt-1">Manage membership payments</p>
                </div>
                ...
                <table class="w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            Current Fiscal Year {{ now()->year }} - {{ now()->year + 1 }} Payment Status
                        </th>
                        <th scope="col"
