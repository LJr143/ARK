    ...
    <ul class="space-y-1">
        ...
        <li>
            <a href="<?php echo e(route('reminders.index')); ?>"
               class="flex items-center p-3 rounded-xl transition-all duration-200 group
                                          <?php echo e(request()->routeIs('reminders.*') ? 'nav-item-active' : 'nav-item-hover'); ?>">
                <div class="flex-shrink-0">
                    <svg
                        class="w-5 h-5 <?php echo e(request()->routeIs('reminders.*') ? 'text-blue-600 icon-active' : 'text-gray-500 group-hover:text-gray-700'); ?>"
                        viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <span class="ml-3 font-medium transition-all duration-300 overflow-hidden whitespace-nowrap
                                                 <?php echo e(request()->routeIs('reminders.*') ? 'text-gray-800' : 'text-gray-600 group-hover:text-gray-800'); ?>"
        ...
        <?php if(auth()->user()->hasAnyRole(['admin', 'superadmin'])): ?>
            ...
            <li>
                <a href="<?php echo e(route('members.index')); ?>"
                   class="flex items-center p-3 rounded-xl transition-all duration-200 group
                                          <?php echo e(request()->routeIs('members*') ? 'nav-item-active' : 'nav-item-hover'); ?>">
                    <div class="flex-shrink-0">
                        <svg
                            class="w-5 h-5 <?php echo e(request()->routeIs('members*') ? 'text-blue-600 icon-active' : 'text-gray-500 group-hover:text-gray-700'); ?>"
                    ...
                    <span class="ml-3 font-medium transition-all duration-300 overflow-hidden whitespace-nowrap
                                                 <?php echo e(request()->routeIs('members*') ? 'text-gray-800' : 'text-gray-600 group-hover:text-gray-800'); ?>"
