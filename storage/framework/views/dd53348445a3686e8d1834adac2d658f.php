            ...
            <li>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center p-3 rounded-lg transition-colors
                   <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-black' : 'text-gray-600 hover:bg-[#F1F5F9]'); ?>">
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-gray-500'); ?>" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="<?php echo e(route('reminders.index')); ?>" class="flex items-center p-3 rounded-lg transition-colors
                   <?php echo e(request()->routeIs('reminders.index') ||  request()->routeIs('manage.reminder') ? 'bg-blue-50 text-black' : 'text-gray-600 hover:bg-[#F1F5F9]'); ?>">
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('reminders.index') ||  request()->routeIs('manage.reminder') ? 'bg-blue-50 text-black' : 'text-gray-600 hover:bg-[#F1F5F9]'); ?>" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
