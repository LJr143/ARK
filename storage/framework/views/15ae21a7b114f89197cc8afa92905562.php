    ...
    <div class="container mx-auto px-4 py-4 lg:py-6 max-w-12xl">
                    ...
                    <div class="flex-1">
                        <div class="relative overflow-hidden bg-white rounded-3xl shadow-2xl mb-8 animate-fade-in-up">
                            ...
                            <div class="relative flex justify-between p-8 lg:p-12">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('send-reminder')): ?>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="px-4 lg:px-6 py-4">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                            <nav class="flex space-x-6 overflow-x-auto">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-reminder-member')): ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-member-reminder')): ?>
            ...
            <div class="p-4 lg:p-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if($showComputationRequestModal): ?>
                    <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
                        <div
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-sm text-gray-500 mb-4 text-center">
                                    <?php echo e(now()->format('M j, Y')); ?><br>
                                    ...
                                    <div class="space-y-3 text-sm">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium">
                                                <?php echo e(isset($memberData['first_name'], $memberData['family_name']) ?
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="font-medium"><?php echo e($memberData['prc_registration_number'] ?? 'Error'); ?></span>
                                        </div>

                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Membership date</span>
                                            <span
                                                class="font-medium"><?php echo e($memberData['membership_date'] ?? '24-Apr-2023'); ?></span>
                                        </div>

                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Chapter Member</span>
                                            <span
                                                class="font-medium"><?php echo e($memberData['current_chapter'] ?? 'Error'); ?></span>
                                        </div>

                                        <div class="flex justify-between">
                                            <span class="text-gray-600">E-mail Address</span>
                                            <span class="font-medium"><?php echo e($memberData['email'] ?? 'Error'); ?></span>
                                        </div>

                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Mobile number</span>
                                            <span class="font-medium"><?php echo e($memberData['mobile'] ?? 'Error'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            I understand and agree to submit my personal information for this request.
                                ...
                                <!-- Loading State -->
                                <!--[if BLOCK]><![endif]--><?php if($submittingRequest): ?>
                                    <div class="mb-4">
                                        <div class="flex items-center justify-center">
                                            <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-blue-500"
                                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($requestResult && !$submittingRequest): ?>
                                    <div class="mb-4 p-4 border rounded-lg">
                                        <!--[if BLOCK]><![endif]--><?php if(isset($requestResult['error']) && $requestResult['error']): ?>
                                            <div class="text-red-600 text-center">
                                                <h4 class="font-medium">Error occurred:</h4>
                                                <p class="text-sm"><?php echo e($requestResult['message']); ?></p>
                                            </div>
                                        <?php else: ?>
                                            <div class="text-green-600 text-center">
                                                <h4 class="font-medium">Request Submitted Successfully!</h4>
                                                <p class="text-sm"><?php echo e($requestResult['message'] ?? 'Your computation breakdown request has been submitted and will be processed soon.'); ?></p>
                                                <!--[if BLOCK]><![endif]--><?php if(isset($requestResult['reference_number'])): ?>
                                                    <p class="text-sm mt-2">Reference Number:
                                                        <strong><?php echo e($requestResult['reference_number']); ?></strong></p>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                ...
                                <div class="flex justify-center space-x-3">
                                    <!--[if BLOCK]><![endif]--><?php if(!$requestResult || $submittingRequest): ?>
                                        <button
                                            ...
                                            <?php if($submittingRequest || !$agreementAccepted): ?> disabled <?php endif; ?>
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <div
                                                ...
                                                <div class="flex flex-wrap gap-3">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('archive-reminder')): ?>
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasRole('member') && $reminder->category->name == 'Deadline'): ?>
                                                            <?php
                                                            ...
                                                            <div class="flex items-center gap-2">
                                                                ...
                                                                <?php else: ?>
                                                                    <p class="text-blue-800 font-semibold">
                                                                        <?php echo e($reminderDetails['period'] ? 'June 2025 - July 2026' : 'No Period Covered'); ?>
                                                ...
                                                <div class="flex items-center justify-between mb-6">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($isEditing): ?>
                                                        <button wire:click="toggleFileUpload"
                                                            ...
                                                            <i class="fas fa-plus"></i>
                                                            <span><?php echo e($showFileUpload ? 'Cancel Upload' : 'Add Files'); ?></span>
                                                        </button>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </div>

                                                <!-- File Upload Section (Visible during editing) -->
                                                <!--[if BLOCK]><![endif]--><?php if($isEditing && $showFileUpload): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $reminderDetails['attachments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex gap-2">
                                                                    ...
                                                                    <!--[if BLOCK]><![endif]--><?php if($isEditing): ?>
                                                                        <button
                                                                            wire:click="confirmRemoveAttachment(<?php echo e($attachment['id']); ?>)"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($removingAttachmentId): ?>
                                                <div
