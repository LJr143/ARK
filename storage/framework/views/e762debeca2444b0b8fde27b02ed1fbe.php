<div>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
                    <div class="text-white">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasRole('member')): ?>
        ...
        <main class="max-w-12xl mx-auto px-4 sm:px-4 lg:px-6 py-6 -mt-6">
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <div wire:loading.remove wire:target="filterByDate">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1"><?php echo e($paidMembers); ?> members</p>
                                </div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($totalMembers > 0): ?>
                            <div class="mt-4">
                                <div class="flex justify-between text-sm text-gray-600 mb-1">
                                    ...
                                    <span class="font-medium"><?php echo e(round(($paidMembers / $totalMembers) * 100)); ?>%</span>
                                </div>
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <div wire:loading.remove wire:target="filterByDate">
                                    <p class="text-2xl font-bold text-red-600 mt-1">₱<?php echo e(number_format($unpaidDues, 2)); ?></p>
                                    <p class="text-sm text-gray-500 mt-1"><?php echo e($unpaidMembers); ?> members</p>
                                </div>
                                <div wire:loading wire:target="filterByDate" class="mt-2 space-y-2">
                                    <div class="h-7 bg-gray-200 rounded animate-pulse"></div>
                                    <div class="h-4 bg-gray-200 rounded w-1/2 animate-pulse"></div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($totalMembers > 0): ?>
                            <div class="mt-4">
                                <div class="flex justify-between text-sm text-gray-600 mb-1">
                                    ...
                                    <span class="font-medium"><?php echo e(round(($unpaidMembers / $totalMembers) * 100)); ?>%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <div wire:loading.remove wire:target="filterByDate">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1"><?php echo e($totalMembers); ?> members</p>
                                </div>
                                <div wire:loading wire:target="filterByDate" class="mt-2 space-y-2">
                                    <div class="h-7 bg-gray-200 rounded animate-pulse"></div>
                                    <div class="h-4 bg-gray-200 rounded w-1/2 animate-pulse"></div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($totalDues > 0): ?>
                            <div class="mt-4">
                                <div class="flex justify-between text-sm text-gray-600 mb-1">
                                    ...
                                    <span class="font-medium"><?php echo e(round(($paidDues / $totalDues) * 100)); ?>%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <?php if(auth()->user()->hasAnyRole('member', 'admin', 'superadmin')): ?>
                        <?php
                        ...
                        ?>
                            ...
                            <!-- Request Status Card -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <!--[if BLOCK]><![endif]--><?php if($existingRequest): ?>
                                <!-- Pending Request -->
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 max-w-xs mx-auto">
                                        <div class="text-sm space-y-2">
                                            <p class="flex justify-between">
                                                ...
                                                <span class="font-medium"><?php echo e($existingRequest->reference_number); ?></span>
                                            </p>
                                            <p class="flex justify-between">
                                                <span class="text-gray-500">Submitted:</span>
                                                <span><?php echo e($existingRequest->created_at->format('M d, Y')); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="space-y-6">
                    <!-- Request History -->
                    <!--[if BLOCK]><![endif]--><?php if(isset($processedRequests) && $processedRequests->count() > 0): ?>
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $processedRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                <?php echo e($request->created_at->format('M d')); ?>
                                        ...
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <!--[if BLOCK]><![endif]--><?php if($request->status === 'approved'): ?>
                                                    <span
                                            ...
                                            <a href="<?php echo e(route('request.history')); ?>" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">View</a>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <!--[if BLOCK]><![endif]--><?php if($processedRequests->count() >= 3): ?>
                                    <div class="text-center pt-2">
                                        <a wire:navigate href="<?php echo e(route('request.history')); ?>"
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-red-600">₱<?php echo e(number_format($unpaidDues, 2)); ?></p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500 mb-1">Active Members</p>
                                    <p class="font-medium text-indigo-600"><?php echo e($totalMembers); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div x-data="{ showModal: <?php if ((object) ('showComputationRequestModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showComputationRequestModal'->value()); ?>')<?php echo e('showComputationRequestModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showComputationRequestModal'); ?>')<?php endif; ?> }" x-cloak x-show="showModal"
        ...
        <div class="relative bg-white rounded-2xl shadow-lg w-full max-w-md sm:max-w-lg md:max-w-xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="bg-white/50 backdrop-blur-sm rounded-xl p-4 mb-4 border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($memberData['first_name'] ?? ''); ?> <?php echo e($memberData['family_name'] ?? ''); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500">PRC#</p>
                                    <p class="font-medium text-gray-900"><?php echo e($memberData['prc_registration_number'] ?? ''); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500">Chapter</p>
                                    <p class="font-medium text-gray-900"><?php echo e($memberData['current_chapter'] ?? ''); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500">Email</p>
                                    <p class="font-medium text-gray-900"><?php echo e($memberData['email'] ?? ''); ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($requestResult): ?>
                <div class="px-4 py-3 sm:px-6"
                     x-data="{ show: true }" x-show="show" x-transition
                     x-init="setTimeout(() => show = false, 5000)">
                    <div class="<?php if($requestResult['error']): ?> bg-red-50 text-red-700 <?php else: ?> bg-green-50 text-green-700 <?php endif; ?> rounded-md p-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <!--[if BLOCK]><![endif]--><?php if($requestResult['error']): ?>
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium">
                                    <?php echo e($requestResult['message']); ?>

                                    <!--[if BLOCK]><![endif]--><?php if(isset($requestResult['reference_number'])): ?>
                                        <br>Reference: <span class="font-bold"><?php echo e($requestResult['reference_number']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </p>
                            </div>
